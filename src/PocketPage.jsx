...
export default function PocketPage() {
  ...
  return <main className="pk-page" ref={root}>
    ...
    <header className="pk-nav"><a href="#top" className="pk-brand" aria-label="Pocket home"><img src="/pocket/Branding/Pocket-logo.png" alt="" />pocket<span>®</span></a><nav aria-label="Pocket navigation"><a href="#interface">The plugin</a><a href="#workflow">Listen</a><a href="#compatibility">Compatibility</a></nav><a className="pk-nav-button" href="#waitlist" onClick={focusSignup}>Get early access <Arrow /></a></header>
    <section className="pk-hero" id="top"><div className="pk-hero-content"><div className="pk-eyebrow"><i /> A little space changes everything</div><h1>Make room<br />for what<br /><em>matters.</em></h1><p>Pocket is a spectral sidechain VST3 plugin that gives every sound<br className="pk-desktop" /> its own place. Less conflict. More connection.</p><div className="pk-hero-actions"><a className="pk-button" href="#waitlist" onClick={focusSignup}>Meet your mix’s missing piece <Arrow /></a><span>Coming soon · VST3 / AU</span></div></div><div className="pk-art"><PocketScene /><div className="pk-art-label"><span>01 | THE POCKET MARK</span><span>SPACE, BY DESIGN</span></div></div><a className="pk-scroll" href="#interface"><span>↓</span> Scroll to find your space</a><div className="pk-hero-note">PRECISION IN THE DETAILS.<br />FEELING IN THE MIX.</div></section>
    ...
    <PocketDemos />
    <section className="pk-compat pk-section" id="compatibility" data-reveal><div><div className="pk-eyebrow">03 / At home in your setup</div><h2>Your session.<br /><em>Meet Pocket.</em></h2><p>Planned for macOS and Windows.<br />Final system requirements will be confirmed at launch.</p></div><div className="pk-platforms"><div><span>01</span><h3>macOS</h3><p>VST3 + Audio Unit</p><small>Planned</small></div><div><span>02</span><h3>Windows</h3><p>VST3</p><small>Planned</small></div></div></section>
